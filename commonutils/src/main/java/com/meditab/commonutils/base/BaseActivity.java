...
import com.meditab.commonutils.utils.DeviceUtils;
...
public class BaseActivity<T> extends AppCompatActivity implements FragmentLoader {
    ...
    public void loadDialogFragment(int containerId, DialogFragment fragment, boolean addToStack, String tag) {
        ...
        if (fragment instanceof BaseDialogFragment && ((BaseDialogFragment) fragment).showAsDialog()) {
            if (addToStack) {
                fragmentStack.push(fragment);
            }
