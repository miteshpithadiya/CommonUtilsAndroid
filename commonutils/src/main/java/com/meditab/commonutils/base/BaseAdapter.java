...
public abstract class BaseAdapter<VH extends RecyclerView.ViewHolder, I> extends RecyclerView.Adapter<VH> {
    ...
    public BaseAdapter(Context mContext, int rowLayoutResourceId, RecyclerView recyclerView, ArrayList<I> itemList, OnItemClickListener onItemClickListener) throws InvalidResourceIdException {
    ...
    public BaseAdapter(Context mContext, int rowLayoutResourceId, RecyclerView recyclerView, ArrayList<I> itemList) throws InvalidResourceIdException {
        this(mContext, rowLayoutResourceId, recyclerView, itemList, null);
    }

    public BaseAdapter(Context mContext, int rowLayoutResourceId, ArrayList<I> itemList) throws InvalidResourceIdException {
        this(mContext, rowLayoutResourceId, null, itemList, null);
    }

    public BaseAdapter(Context mContext, int rowLayoutResourceId, ArrayList<I> itemList, OnItemClickListener onItemClickListener) throws InvalidResourceIdException {
