...
public class BeaconUtilsbackup {

    private static BeaconUtilsbackup instance;
    private ArrayList<MonitoringListener> monitoringListeners = new ArrayList<>();
    private BeaconManager beaconManager;
    private Context mContext;

    public BeaconUtilsbackup(Context context) {
        this.mContext = context;
        init();
    }

    public static BeaconUtilsbackup getInstance(Context context) {
        if (instance == null) {
            instance = new BeaconUtilsbackup(context);
        }
            ...
            public void onBeaconsDiscovered(Region region, List<Beacon> list) {
                ...
                if (!list.isEmpty()) {
                    ...
                    for (Beacon b : list) {
                        ...
                        beaconManager.startMonitoring(new Region("clinic" + c, b.getProximityUUID(), b.getMajor(), b.getMinor()));
                    }
...
//                }
        ...
        // beaconManager.setBackgroundScanPeriod(5000, 60000);
...
//                    beaconManager.startMonitoring(region);
                ...
                beaconManager.startRanging(new Region("clinicR", UUID.fromString("5E0C63DE-05F0-1F1B-BF2D-BC3936CEA4C0"), 0, 0));
                //  }
            }
        });
