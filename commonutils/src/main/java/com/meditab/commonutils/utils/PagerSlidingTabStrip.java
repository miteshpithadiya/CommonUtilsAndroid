...
public class PagerSlidingTabStrip extends HorizontalScrollView {
    ...
    private int tabTextColor = getResources().getColor(android.R.color.black);
    ...
    public PagerSlidingTabStrip(Context context, AttributeSet attrs, int defStyle) {
        ...
        indicatorColor = a
                .getColor(R.styleable.PagerSlidingTabStrip_indicatorColor, indicatorColor);
        underlineColor = a
                .getColor(R.styleable.PagerSlidingTabStrip_underlineColor, underlineColor);
        ...
        underlineHeight = a.getDimensionPixelSize(R.styleable.PagerSlidingTabStrip_underlineHeight,
                underlineHeight);
        tabPadding = a.getDimensionPixelSize(R.styleable.PagerSlidingTabStrip_tabPaddingLeftRight,
                tabPadding);
        tabBackgroundResId = a.getResourceId(R.styleable.PagerSlidingTabStrip_ptabBackground,
                tabBackgroundResId);
        shouldExpand = a.getBoolean(R.styleable.PagerSlidingTabStrip_shouldExpand, shouldExpand);
        scrollOffset = a.getDimensionPixelSize(R.styleable.PagerSlidingTabStrip_scrollOffset,
                scrollOffset);

        textColor = a.getColor(R.styleable.PagerSlidingTabStrip_text_Color, textColor);
...
//        if (this.pager.getAdapter().getClass() != MyAppointmentSwipePageAdapter.class) {
//            if (Global.IS_TWO_PANE) {
//                tab.setWidth(Global.INT_RIGHT_PANE * getResources().getDisplayMetrics().widthPixels
//                        / ((Global.INT_LEFT_PANE + Global.INT_RIGHT_PANE) * tabCount));
//            } else {
//                tab.setWidth(getResources().getDisplayMetrics().widthPixels / tabCount);
//            }
//        }
...
//            v.setBackgroundResource(tabBackgroundResId);
            if (Build.VERSION.SDK_INT >= 16) {
                v.setBackground(getResources().getDrawable(R.drawable.background_tab));
            } else {
                v.setBackground(getResources().getDrawable(R.drawable
                        .background_tab));
            }
//            v.setBackgroundColor(getResources().getColor(R.color.cell_bg));

//            shouldExpand = this.pager.getAdapter().getClass() == MyAppointmentSwipePageAdapter.class;
